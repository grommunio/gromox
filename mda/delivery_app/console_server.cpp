...
#define STOP_STRING			"delivery service is going to shut down...\r\n"
...
static void console_server_install_command()
{
	...
	console_server_register_command(NULL, cmd_handler_mpc_plugins);
	
	console_server_register_command(NULL, cmd_handler_service_plugins);
}
