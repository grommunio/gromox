...
extern int nsp_interface_query_rows(NSPI_HANDLE, uint32_t flags, STAT *, uint32_t table_count, uint32_t *table, uint32_t count, const LPROPTAG_ARRAY *, PROPROW_SET **);
...
extern int nsp_interface_get_props(NSPI_HANDLE, uint32_t flags, const STAT *, const LPROPTAG_ARRAY *, PROPERTY_ROW **);
...
extern int nsp_interface_mod_props(NSPI_HANDLE, uint32_t reserved, const STAT *, const PROPTAG_ARRAY *, const PROPERTY_ROW *);
extern int nsp_interface_get_specialtable(NSPI_HANDLE, uint32_t flags, const STAT *, uint32_t *version, PROPROW_SET **pprows);
extern int nsp_interface_get_templateinfo(NSPI_HANDLE, uint32_t flags, uint32_t type, const char *dn, uint32_t codepage, uint32_t locale_id, PROPERTY_ROW **ppdata);
