...
template<typename T> T *cu_alloc() { return static_cast<T *>(cu_alloc1(sizeof(T))); }
template<typename T> T *cu_alloc(size_t elem) { return static_cast<T *>(cu_alloc1(sizeof(T) * elem)); }
