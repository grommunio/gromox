...
extern ec_error_t zs_getsendpermissions(GUID ses, BINARY store_entryid, uint32_t *permissions);
extern ec_error_t zs_getdelegates(GUID ses, uint32_t mode, std::vector<std::string> *delegates);
