...
extern ec_error_t zs_rulesexecute(GUID ses, uint32_t fld_handle, const BINARY_ARRAY *entryids, uint32_t action_flags, uint32_t *processed, uint32_t *skipped, uint32_t *failed);
