...
struct message_object {
	...
	ec_error_t get_props(uint32_t size_limit, proptag_cspan tags, TPROPVAL_ARRAY *vals) const;
	ec_error_t set_props(const TPROPVAL_ARRAY *vals, PROBLEM_ARRAY *);
	ec_error_t remove_props(proptag_cspan tags, PROBLEM_ARRAY *);
