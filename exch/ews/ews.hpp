...
class EWSContext {
	...
	void loadSpecial(const std::string&, uint64_t, uint64_t, Structures::tMeetingResponseMessage &, uint64_t) const;
	void loadSpecial(const std::string&, uint64_t, uint64_t, Structures::tMeetingCancellationMessage &, uint64_t) const;
