...
extern BOOL exmdb_bouncer_make_content(const char *from, const char *rcpt, sqlite3 *, uint64_t msg_id, const char *bounce_type, char *mime_from, char *subject, char *content_type, char *content);
