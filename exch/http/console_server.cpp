...
#define STOP_STRING			"http service is going to shut down...\r\n"
...
static void console_server_install_command()
{
    ...
    console_server_register_command("http",
                                    cmd_handler_http_control);
	console_server_register_command("rpc",
                                    cmd_handler_rpc_control);
	...
	console_server_register_command(NULL,
									cmd_handler_proc_plugins);
	console_server_register_command(NULL,
									cmd_handler_hpm_plugins);
	console_server_register_command(NULL,
