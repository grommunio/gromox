...
RETRYING:
	...
	sprintf(sql_string, "SELECT password, group_status "
		"FROM groups WHERE groupname='%s'", temp_name);
	...
	sprintf(sql_string, "SELECT homedir FROM "
