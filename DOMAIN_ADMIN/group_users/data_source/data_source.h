...
enum {
	ADD_RESULT_OK = 0,
	ADD_RESULT_NOGROUP,
	ADD_RESULT_GROUPSIZEFULL,
	ADD_RESULT_GROUPUSERFULL,
	ADD_RESULT_NODOMAIN,
	ADD_RESULT_DOMAINNOTMAIN,
	ADD_RESULT_DOMAINSIZEFULL,
	ADD_RESULT_DOMAINUSERFULL,
	ADD_RESULT_MLIST,
	ADD_RESULT_EXIST
};
...
enum {
	...
	EDIT_RESULT_GROUPSIZEFULL,
	EDIT_RESULT_DOMAINSIZEFULL,
	EDIT_RESULT_NOTMAIN
};

enum {
	ALIAS_RESULT_OK = 0,
	ALIAS_RESULT_NOGROUP,
