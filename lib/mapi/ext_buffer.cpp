...
{
	return pext->g_uint8(reinterpret_cast<uint8_t *>(v));
}
...
{
	return pext->g_uint16(reinterpret_cast<uint16_t *>(v));
}
...
{
	return pext->g_uint32(reinterpret_cast<uint32_t *>(v));
}
...
{
	return pext->g_uint64(reinterpret_cast<uint64_t *>(v));
}
