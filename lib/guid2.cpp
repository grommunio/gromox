...
const GUID PSETID_ATTACHMENT =
	/* {96357F7F-59E1-47D0-99A7-46515C183B54} */
	{0x96357F7F, 0x59E1, 0x47D0, {0x99, 0xA7}, {0x46, 0x51, 0x5C, 0x18, 0x3B, 0x54}};
...
const GUID PSETID_XMLEXTRACTEDENTITIES =
	/* {23239608-685D-4732-9C55-4C95CB4E8E33} */
	{0x23239608, 0x685D, 0x4732, {0x9C, 0x55}, {0x4C, 0x95, 0xCB, 0x4E, 0x8E, 0x33}};
