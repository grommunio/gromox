...
int main(int argc, const char **argv)
{
	...
	snprintf(temp_path, sizeof(temp_path), "%s/ip_blacklist.txt", data_path);
	snprintf(white_path, sizeof(white_path), "%s/ip_whitelist.txt", data_path);
	snprintf(lang_path, sizeof(lang_path), "%s/ip_blacklist", data_path);
