...
int main(int argc, const char **argv)
{
	...
	snprintf(temp_path, sizeof(temp_path), "%s/ip_whitelist.txt", data_path);
	snprintf(black_path, sizeof(black_path), "%s/ip_blacklist.txt", data_path);
	snprintf(lang_path, sizeof(lang_path), "%s/ip_whitelist", data_path);
	whitelist_ui_init(temp_path, black_path, mount_path,
		str_value, lang_path);
