...
int main(int argc, char **argv)
{
	...
	sprintf(temp_path, "%s/%s/ip_whitelist.txt", work_path, data_path);
	sprintf(black_path, "%s/%s/ip_blacklist.txt", work_path, data_path);
	sprintf(lang_path, "%s/%s/ip_whitelist", work_path, data_path);
