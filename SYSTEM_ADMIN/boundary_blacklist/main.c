...
int main(int argc, const char **argv)
{
	...
	snprintf(temp_path, sizeof(temp_path), "%s/boundary_blacklist.txt", data_path);
	snprintf(lang_path, sizeof(lang_path), "%s/boundary_blacklist", data_path);
	blacklist_ui_init(temp_path, mount_path, str_value, lang_path);
