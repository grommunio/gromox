...
int main(int argc, const char **argv)
{
	...
	snprintf(temp_path, sizeof(temp_path), "%s/keyword_group.txt", data_path);
	snprintf(lang_path, sizeof(lang_path), "%s/keyword_group", data_path);
	group_ui_init(temp_path, mount_path, str_value, lang_path);
