...
int main(int argc, const char **argv)
{
	...
	pconfig = config_file_init2(opt_config_file, config_default_path("session.cfg"));
	...
	int ret = pthread_create(&thr_id, NULL, accept_work_func,
	...
	printf("[system]: SESSION is now running\n");
