...
int main(int argc, const char **argv)
{
	...
	snprintf(list_path, sizeof(list_path), "%s/cidb_list.txt", data_path);
	snprintf(temp_path, sizeof(temp_path), "%s/archiver_list", data_path);
	list_ui_init(list_path, mount_path, str_value, temp_path);
