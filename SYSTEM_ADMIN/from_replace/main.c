...
int main(int argc, const char **argv)
{
	...
	snprintf(temp_path, sizeof(temp_path), "%s/from_replace.txt", data_path);
	snprintf(lang_path, sizeof(lang_path), "%s/from_replace", data_path);
	list_ui_init(temp_path, mount_path, str_value, lang_path);
