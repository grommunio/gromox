...
int main(int argc, const char **argv)
{
	...
	snprintf(temp_path, sizeof(temp_path), "%s/spam_statistic", data_path);
	translator_init(temp_path);
	...
	snprintf(lang_path, sizeof(lang_path), "%s/daily_statistic", data_path);
