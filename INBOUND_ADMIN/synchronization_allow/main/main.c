...
int main(int argc, char **argv)
{
	...
	sprintf(temp_path, "%s/%s/synchronization_allow.txt", work_path, data_path);
	sprintf(lang_path, "%s/%s/synchronization_allow", work_path, data_path);
	list_ui_init(temp_path, str_value, lang_path);
