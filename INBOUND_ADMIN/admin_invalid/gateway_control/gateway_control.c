...
#define DUMP_COMMAND	"invalid_user.svc dump ../data/smtp/temp_invalid.txt\r\n"

#define CLEAR_COMMAND	"invalid_user.svc clear\r\n"

#define REMOVE_COMMAND	"invalid_user.svc remove %s\r\n"
...
void gateway_control_remove(const char *address)
{
	...
	sprintf(temp_command, REMOVE_COMMAND, address);
