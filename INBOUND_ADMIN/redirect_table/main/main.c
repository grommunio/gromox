...
int main(int argc, char **argv)
{
	...
	sprintf(temp_path, "%s/%s/redirect_table.txt", work_path, data_path);
	sprintf(dns_path, "%s/%s/dns_table.txt", work_path, data_path);
	sprintf(lang_path, "%s/%s/redirect_table", work_path, data_path);
	table_ui_init(temp_path, dns_path, mount_path, str_value, lang_path);
