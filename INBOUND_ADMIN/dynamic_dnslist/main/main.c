...
int main(int argc, char **argv)
{
	...
	sprintf(temp_path, "%s/%s/dynamic_dnslist.txt", work_path, data_path);
	sprintf(lang_path, "%s/%s/dynamic_dnslist", work_path, data_path);
	dnslist_ui_init(temp_path, mount_path, str_value, lang_path);
