...
int main(int argc, const char **argv)
{
	...
	pconfig = config_file_init2(opt_config_file, config_default_path("asession.cfg"));
	...
	if (NULL == str_value) {
		g_conn_num = 5;
		config_file_set_value(pconfig, "SESSION_CONNECTION_NUM", "5");
	} else {
	...
	if (str_value == NULL) {
		HX_strlcpy(CS_PATH, PKGRUNDIR "/asession.sock", sizeof(CS_PATH));
