...
extern int icp_capability(std::span<char *>, imap_context &);
extern int icp_id(std::span<char *>, imap_context &);
extern int icp_noop(std::span<char *>, imap_context &);
extern int icp_logout(std::span<char *>, imap_context &);
extern int icp_starttls(std::span<char *>, imap_context &);
extern int icp_authenticate(std::span<char *>, imap_context &);
extern int icp_username(const char *cmdbuf, imap_context &);
extern int icp_password(const char *cmdbuf, imap_context &);
extern int icp_login(std::span<char *> argv, imap_context &);
extern int icp_idle(std::span<char *> argv, imap_context &);
extern int icp_select(std::span<char *> argv, imap_context &);
extern int icp_examine(std::span<char *> argv, imap_context &);
extern int icp_create(std::span<char *> argv, imap_context &);
extern int icp_delete(std::span<char *> argv, imap_context &);
extern int icp_rename(std::span<char *> argv, imap_context &);
extern int icp_subscribe(std::span<char *> argv, imap_context &);
extern int icp_unsubscribe(std::span<char *> argv, imap_context &);
extern int icp_list(std::span<char *> argv, imap_context &);
extern int icp_xlist(std::span<char *> argv, imap_context &);
extern int icp_lsub(std::span<char *> argv, imap_context &);
extern int icp_status(std::span<char *> argv, imap_context &);
extern int icp_append(std::span<char *> argv, imap_context &);
extern int icp_long_append_begin(std::span<char *> argv, imap_context &);
extern int icp_long_append_end(std::span<char *> argv, imap_context &);
extern int icp_check(std::span<char *> argv, imap_context &);
extern int icp_close(std::span<char *> argv, imap_context &);
extern int icp_expunge(std::span<char *> argv, imap_context &);
extern int icp_unselect(std::span<char *> argv, imap_context &);
extern int icp_search(std::span<char *> argv, imap_context &);
extern int icp_fetch(std::span<char *> argv, imap_context &);
extern int icp_store(std::span<char *> argv, imap_context &);
extern int icp_copy(std::span<char *> argv, imap_context &);
extern int icp_uid_search(std::span<char *> argv, imap_context &);
extern int icp_uid_fetch(std::span<char *> argv, imap_context &);
extern int icp_uid_store(std::span<char *> argv, imap_context &);
extern int icp_uid_copy(std::span<char *> argv, imap_context &);
extern int icp_uid_expunge(std::span<char *> argv, imap_context &);
