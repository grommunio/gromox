...
extern int (*system_services_get_uid)(const char *, const char *, const std::string &mid_string, unsigned int *uid);
...
extern int (*system_services_rename_folder)(const char *, const std::string &, const char *, int *);
...
extern int (*system_services_copy_mail)(const char *, const std::string &fld, const std::string &mid, const char *dst_fld, std::string &dst_mid, int *);
