...
extern int icp_starttls(std::span<std::string>, imap_context &);
extern int icp_authenticate(std::span<std::string>, imap_context &);
extern int icp_username(const char *cmdbuf, imap_context &);
extern int icp_password(const char *cmdbuf, imap_context &);
extern int icp_login(std::span<std::string> argv, imap_context &);
extern int icp_idle(std::span<std::string> argv, imap_context &);
extern int icp_select(std::span<std::string> argv, imap_context &);
extern int icp_examine(std::span<std::string> argv, imap_context &);
extern int icp_create(std::span<std::string> argv, imap_context &);
extern int icp_delete(std::span<std::string> argv, imap_context &);
extern int icp_rename(std::span<std::string> argv, imap_context &);
extern int icp_subscribe(std::span<std::string> argv, imap_context &);
extern int icp_unsubscribe(std::span<std::string> argv, imap_context &);
extern int icp_list(std::span<std::string> argv, imap_context &);
extern int icp_xlist(std::span<std::string> argv, imap_context &);
extern int icp_lsub(std::span<std::string> argv, imap_context &);
extern int icp_status(std::span<std::string> argv, imap_context &);
extern int icp_append(std::span<std::string> argv, imap_context &);
extern int icp_long_append_begin(std::span<std::string> argv, imap_context &);
extern int icp_long_append_end(std::span<std::string> argv, imap_context &);
extern int icp_check(std::span<std::string> argv, imap_context &);
extern int icp_close(std::span<std::string> argv, imap_context &);
extern int icp_expunge(std::span<std::string> argv, imap_context &);
extern int icp_unselect(std::span<std::string> argv, imap_context &);
extern int icp_search(std::span<std::string> argv, imap_context &);
