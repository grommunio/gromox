...
extern int (*system_services_fetch_simple)(const char *, const char *, const gromox::imap_seq_list &, XARRAY *, int *);
extern int (*system_services_fetch_detail)(const char *, const char *, const gromox::imap_seq_list &, XARRAY *, int *);
