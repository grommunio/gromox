...
EXMIDL(deliver_message, (const char *dir, const char *from_address, const char *account, uint32_t cpid, const MESSAGE_CONTENT *pmsg, const char *pdigest, IDLOUT uint32_t *result))
EXMIDL(write_message, (const char *dir, const char *account, uint32_t cpid, uint64_t folder_id, const MESSAGE_CONTENT *pmsgctnt, IDLOUT ec_error_t *e_result))
