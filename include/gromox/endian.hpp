...
#	define cpu_to_be16(x) static_cast<uint16_t>(x)
#	define cpu_to_be32(x) static_cast<uint32_t>(x)
#	define cpu_to_be64(x) static_cast<uint64_t>(x)
...
#else
#	define cpu_to_le16(x) static_cast<uint16_t>(x)
#	define cpu_to_le32(x) static_cast<uint32_t>(x)
#	define cpu_to_le64(x) static_cast<uint64_t>(x)
#	define cpu_to_be16(x) __builtin_bswap16(x)
#	define cpu_to_be32(x) __builtin_bswap32(x)
#	define cpu_to_be64(x) __builtin_bswap64(x)
#	define le16_to_cpu(x) static_cast<uint16_t>(x)
#	define le32_to_cpu(x) static_cast<uint32_t>(x)
#	define le64_to_cpu(x) static_cast<uint64_t>(x)
