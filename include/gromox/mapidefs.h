...
enum {
	...
	META_TAG_DNPREFIX = PROP_TAG(PT_STRING8, 0x4008), /* OXCFXICS §2.2.4.1.5 */
	...
	META_TAG_ECWARNING = PROP_TAG(PT_LONG, 0x400F),
	STARTFAIMSG = PROP_TAG(PT_LONG, 0x4010),
	META_TAG_NEWFXFOLDER = PROP_TAG(PT_BINARY, 0x4011),
	...
	META_TAG_FXDELPROP = PROP_TAG(PT_LONG, 0x4016),
	META_TAG_IDSETGIVEN = PROP_TAG(PT_LONG, 0x4017), /* OXCFXICS §2.2.1.1 */
	META_TAG_IDSETGIVEN1 = PROP_TAG(PT_BINARY, 0x4017),
	FXERRORINFO = PROP_TAG(PT_LONG, 0x4018),
	META_TAG_IDSETNOLONGERINSCOPE = PROP_TAG(PT_BINARY, 0x4021),
	META_TAG_IDSETREAD = PROP_TAG(PT_BINARY, 0x402D),
	META_TAG_IDSETUNREAD = PROP_TAG(PT_BINARY, 0x402E),
	...
	META_TAG_INCREMENTALSYNCMESSAGEPARTIAL = PROP_TAG(PT_LONG, 0x407A),
	INCRSYNCGROUPINFO = PROP_TAG(PT_BINARY, 0x407B),
	META_TAG_INCRSYNCGROUPID = PROP_TAG(PT_LONG, 0x407C),
	...
	META_TAG_IDSETEXPIRED = PROP_TAG(PT_BINARY, 0x6793),
	META_TAG_CNSETSEEN = PROP_TAG(PT_BINARY, 0x6796),
	PidTagChangeNumber = PROP_TAG(PT_I8, 0x67A4),
	PR_ASSOCIATED = PROP_TAG(PT_BOOLEAN, 0x67AA), /* PidTagAssociated */
	META_TAG_CNSETREAD = PROP_TAG(PT_BINARY, 0x67D2),
	META_TAG_CNSETSEENFAI = PROP_TAG(PT_BINARY, 0x67DA),
	META_TAG_IDSETDELETED = PROP_TAG(PT_BINARY, 0x67E5), /* OXCFXICS §2.2.1.3 */
