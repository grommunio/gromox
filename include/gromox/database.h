...
extern GX_EXPORT [[nodiscard]] int gx_sql_exec(sqlite3 *, const char *query, unsigned int flags = 0);
inline GX_EXPORT [[nodiscard]] int gx_sql_exec(sqlite3 *d, const std::string &q, unsigned int fl = 0) { return gx_sql_exec(d, q.c_str(), fl); }
