...
struct GX_EXPORT EXT_PULL {
	...
	pack_result g_uint16_a(std::vector<uint16_t> *, uint8_t ix = 4);
	...
	pack_result g_uint32_a(std::vector<uint32_t> *, uint8_t ix = 4);
	...
	pack_result g_float_a(std::vector<float> *, uint8_t ix = 4);
	...
	pack_result g_guid_a(std::vector<GUID> *, uint8_t ix = 4);
