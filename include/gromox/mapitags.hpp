...
enum {
	...
	// PR_SERVICE_NAME = PROP_TAG(PT_TSTRING, 0x3D09), /* PidTagServiceName */
	// PR_SERVICE_DLL_NAME = PROP_TAG(PT_TSTRING, 0x3D0A), /* PidTagServiceDllName */
	...
	// PR_SERVICE_SUPPORT_FILES = PROP_TAG(PT_MV_TSTRING, 0x3D0F), /* PidTagServiceSupportFiles */
	// PR_SERVICE_DELETE_FILES = PROP_TAG(PT_MV_TSTRING, 0x3D10), /* PidTagServiceDeleteFiles */
	// PR_AB_SEARCH_PATH_UPDATE = PROP_TAG(PT_BINARY, 0x3D11), /* PidTagAbSearchPathUpdate */
	// PR_PROFILE_NAME = PROP_TAG(PT_TSTRING, 0x3D12), /* PidTagProfileName */
	...
	// PR_IDENTITY_DISPLAY = PROP_TAG(PT_TSTRING, 0x3E00), /* PidTagIdentityDisplay */
	...
	// PR_RESOURCE_PATH = PROP_TAG(PT_TSTRING, 0x3E07), /* PidTagResourcePath /*
	// PR_STATUS_STRING = PROP_TAG(PT_TSTRING, 0x3E08), /* PidTagStatusString */
	...
	// PR_REMOTE_PROGRESS_TEXT = PROP_TAG(PT_TSTRING, 0x3E0C), /* PidTagRemoteProgressText */
	...
	// PR_RULE_VERSION = PROP_TAG(PT_I2, 0x668D),
