...
static SMTP_ERROR_CODE g_default_smtp_error_code_table[] = {
    ...
    { 2174007, "421 Access is denied from your IP <remote_ip> for audit reason, try later" },
    ...
    { 2175012, "521 Access is denied from your IP <remote_ip>" },
    ...
    { 2175031, "554 Relay from your IP <remote_ip> is denied" },
