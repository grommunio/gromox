...
if (isset($xml_request->Request->AcceptableResponseSchema) &&
	...
	$server_url = "https://" . get_user_http_proxy($uinfo['maildir'], $host_name) . "/Microsoft-Server-ActiveSync";
	...
	//$Protocol->addChild('EcpUrl-um', '?rfr=olk&amp;p=customize/voicemail.aspx&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-aggr', '?rfr=olk&amp;p=personalsettings/EmailSubscriptions.slab&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-mt' , 'PersonalSettings/DeliveryReport.aspx?rfr=olk&amp;exsvurl=1&amp;IsOWA=&lt;IsOWA&gt;&amp;MsgID=&lt;MsgID&gt;&amp;Mbx=&lt;Mbx&gt;&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-ret', '?rfr=olk&amp;p=organize/retentionpolicytags.slab&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-sms', '?rfr=olk&amp;p=sms/textmessaging.slab&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-publish', 'customize/calendarpublishing.slab?rfr=olk&amp;exsvurl=1&amp;FldID=&lt;FldID&gt;&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-tm', '?rfr=olk&amp;ftr=TeamMailbox&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-tmCreating', '?rfr=olk&amp;ftr=TeamMailboxCreating&amp;SPUrl=&lt;SPUrl&gt;&amp;Title=&lt;Title&gt;&amp;SPTMAppUrl=&lt;SPTMAppUrl&gt;&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-tmEditing', '?rfr=olk&amp;ftr=TeamMailboxEditing&amp;Id=&lt;Id&gt;&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	//$Protocol->addChild('EcpUrl-extinstall', 'Extension/InstalledExtensions.slab?rfr=olk&amp;exsvurl=1&amp;realm=' . $uinfo['domain']);
	$Protocol->addChild('ServerExclusiveConnect', 'off');
	$Protocol = $Account->addChild('Protocol');
	$Protocol->addChild('Type', 'EXPR');
	$Protocol->addChild('Server', get_user_http_proxy($uinfo['maildir'], $host_name));
